...
const splanJuanJiDian = new schoolPlan("卷绩点", "消耗心情、精力，小幅消耗体力。提高期末考试成绩（仅限本学期）。", 0, -GRI(8,12), -GRI(4,6), -GRI(8,12), 0, 0, 0, GRI(6,9), 0, 0, 0);
...
const splanChenPao = new schoolPlan("早起晨跑", "清醒了一整天，状态也好了。（恢复体力、精力，心情变好。）", 0, GRI(4,6), GRI(8,12), GRI(4,6), 0, 0, 0, 0, 0, -GRI(1,2), 0);
const splanZhengLi = new schoolPlan("整理笔记", "把课上重点捋清楚了。（小幅提升智力，期末成绩提高。）", 0, 0, 0, -GRI(4,6), GRI(1,2), 0, 0, GRI(3,6), 0, 0, 0);
const splanJingZuo = new schoolPlan("静坐冥想", "小幅恢复心情、精力，提升专注力。", 0, GRI(4,6), 0, GRI(4,6), GRI(1,2), 0, 0, 0, 0, -1, 0);
const splanXueXiHui = new schoolPlan("参加学习小组", "小幅消耗精力，提升智力和眼界。", 0, 0, 0, -GRI(4,6), GRI(1,2), GRI(1,2), 0, 0, 0, 0, 0);
const splanYueDu = new schoolPlan("图书馆阅读", "沉浸在书海中，开阔视野。（小幅提升智力与眼界，消耗心情与精力。）", 0, -GRI(4,6), 0, -GRI(4,6), GRI(1,2), GRI(1,2), 0, 0, 0, 0, 0);
const splanJianShen = new schoolPlan("健身房锻炼", "挥洒汗水，强健体魄。（消耗金钱与精力，提升体力、心情与战斗力。）", -GRI(30,50), GRI(4,6), GRI(6,10), -GRI(8,12), 0, 0, 0, 0, GRI(1,2), 0, 0);
const splanWuShui = new schoolPlan("午睡", "中午不睡，下午崩溃。补个觉再说。（恢复精力。）", 0, GRI(2,4), 0, GRI(10,15), 0, 0, 0, 0, 0, 0, 0);
const splanKaFei = new schoolPlan("喝咖啡", "来杯冰美式，提神醒脑。（消耗金钱，恢复精力、心情。）", -GRI(20,35), GRI(5,8), 0, GRI(8,12), 0, 0, 0, 0, 0, 0, 0);
const lowSplanList = [splanFaDai, splanJuanJiDian, splanDaGong, splanLiCai, splanDuiXian, splanChenPao, splanZhengLi, splanJingZuo, splanXueXiHui, splanYueDu, splanJianShen, splanWuShui, splanKaFei];

//1决断 约等于 40状态
//1属性 约等于 -5风险
//1examBase = 5状态
const splanLvYou = new schoolPlan("周边穷游", "花五百块钱左右，较大幅度提升心情、眼界。但会消耗体力、精力。", -GRI(400,600), GRI(12,17), -GRI(8,12), -GRI(8,12), 0, GRI(2,4), 0, 0, 0, 0, 0);
const splanBaoBan = new schoolPlan("报班学习", "花一千块钱左右，消耗精力，较大幅度提升智力、眼界。", -GRI(800,1200), 0, 0, -GRI(8,12), GRI(2,4), GRI(2,4), 0, 0, 0, 0, 0);
const splanXunXin = new schoolPlan("考证", "消耗精力、心情，提升智力、财商。报名费几百块。", -GRI(200,400), -GRI(8,12), 0, -GRI(8,12), GRI(2,4), 0, GRI(2,4), 0, 0, 0, 0);
const splanMaiDaAn = new schoolPlan("买答案", "花一千块钱左右，大幅提升期末考试成绩。但是有风险。", -GRI(800,1200), 0, 0, 0, 0, 0, 0, GRI(15,22), 0, GRI(3,5), 0);
const splanZiMeiTi = new schoolPlan("做自媒体", "消耗心情、精力，可能赚可能亏。或许能提升眼界。", GRI(-1600,4000), -GRI(6,10), 0, -GRI(6,10), 0, GRI(0,1), 0, 0, 0, 0, 0);
const splanSheTuan = new schoolPlan("社团项目", "团队协作让你收获不少。（提升眼界与心情。）", 0, GRI(4,6), 0, 0, 0, GRI(1,2), 0, 0, 0, 0, 0);
const splanJingSaiTuan = new schoolPlan("组队竞赛", "和同学一起肝比赛。（提升智力，期末成绩提高。）", -GRI(300,600), -GRI(4,6), -GRI(4,6), -GRI(6,10), GRI(2,3), 0, 0, GRI(6,10), 0, 0, 0);
const splanWangKe = new schoolPlan("付费网课", "购买专业技能课程，自我充电。（消耗金钱与精力，提升智力与财商。）", -GRI(100,200), 0, 0, -GRI(6,10), GRI(1,3), 0, GRI(1,2), 0, 0, 0, 0);
const splanMaiYi = new schoolPlan("街头卖艺", "在路边弹吉他唱歌，锻炼胆量还能赚钱。（消耗体力，提升金钱与战斗力。）", GRI(50,150), 0, -GRI(10,15), -GRI(4,6), 0, 0, 0, 0, GRI(2,3), 0, 0);
const splanAnMo = new schoolPlan("推拿按摩", "缓解肌肉疲劳，一身轻松。（消耗金钱，大幅恢复体力、精力。）", -GRI(100,200), GRI(5,10), GRI(15,20), GRI(15,20), 0, 0, 0, 0, 0, 0, 0);
const splanYangSheng = new schoolPlan("养生", "泡脚、喝茶、早睡。（恢复体力、精力，降低风险。）", 0, GRI(5,8), GRI(10,15), GRI(10,15), 0, 0, 0, 0, 0, -GRI(1,2), 0);
const middleSplanList = [splanLvYou, splanBaoBan, splanXunXin, splanMaiDaAn, splanZiMeiTi, splanSheTuan, splanJingSaiTuan, splanWangKe, splanMaiYi, splanAnMo, splanYangSheng];
...
const splanHeiKe = new schoolPlan("威胁学霸做替考", "极大幅提高期末考试成绩。", 0, 0, 0, 0, 0, 0, 0, GRI(22,30), 0, GRI(3,5), 0);
...
const splanGanRao = new schoolPlan("不让室友学习", "消耗体力，提高自己的期末成绩，较大幅度提高战斗力。但是会变笨。", 0, 0, -GRI(8,12), 0, -GRI(1,2), 0, 0, GRI(6,9), GRI(2,4), GRI(2,4), 0);
const splanJiaoLiu = new schoolPlan("校际交流", "参加外校交流活动，视野大开。（提升智力与眼界。）", -GRI(1200,2000), GRI(4,6), -GRI(4,6), 0, GRI(2,3), GRI(2,3), 0, 0, 0, 0, 0);
const splanChuangYe = new schoolPlan("校园创业", "尝试在学校里做点小生意，风险与机遇并存。（消耗大量精力，提升财商与眼界。）", -GRI(500,1000), 0, 0, -GRI(20,30), 0, GRI(2,4), GRI(3,5), 0, 0, GRI(1,2), 0);
const highSplanList = [splanTangPing, splanHeiKe, splanChaoGu, splanLianAi, splanGanRao, splanJiaoLiu, splanChuangYe];
...
const splanHaiWai = new schoolPlan("海外访学", "短期访学体验，眼界和智力双提升。（花费不菲。）", -GRI(12000,18000), GRI(8,12), -GRI(4,6), 0, GRI(4,6), GRI(4,6), 0, 0, 0, 0, 0);
const exSplanList = [splanGeJiuCai, splanTiKao, splanChanHui, splanKeYan, splanJiuYe, splanDuJia, splanHaiWai];
...
const seventShouJi = new specialEvent("手机丢了", "排队买饭时手机不翼而飞。心情瞬间跌到谷底。（损失一笔钱，心情、精力下降。）", -GRI(800,1500), -GRI(8,12), 0, -GRI(4,6), 0, 0, 0, GRI(1,2), 0, 0);
const seventDuanWang = new specialEvent("宿舍断网", "运营商突发故障，网断了一整周。学习效率下降，心态也崩了。（心情、精力下降，期末成绩略受影响。）", 0, -GRI(4,6), 0, -GRI(8,12), 0, 0, 0, 0, 0, -GRI(4,6));
const badSeventList = [seventMaiBi, seventKeGai, seventChaoJia, seventXueHan, seventHengHuo, seventShouJi, seventDuanWang];
//极端负面事件
...
const seventZhuYuan = new specialEvent("高烧住院", "连续几天高烧不退，被送进医院。病床上的时间被迫清空。（大幅消耗体力、精力、心情，还要花钱。）", -GRI(2000,4000), -GRI(20,30), -GRI(30,40), -GRI(20,30), 0, 0, 0, GRI(4,6), 0, 0);
const seventShiGu = new specialEvent("实验室事故", "操作失误导致实验事故。虽然没有大碍，但留下阴影，状态受损。（大幅消耗体力、精力，智商略降，风险上升。）", 0, -GRI(10,20), -GRI(10,20), -GRI(15,25), -GRI(2,4), 0, 0, GRI(2,3), 0, 0);
const vbadSeventList = [seventZhaPian, seventXiaDu, seventJueWang, seventChuanXiao, seventDiuShuJu, seventZhuYuan, seventShiGu];
...
const seventZhiYuan = new specialEvent("志愿活动", "跟同学一起参加志愿活动，氛围很暖。（恢复心情、精力。）", 0, GRI(6,10), 0, GRI(6,10), 0, 0, 0, 0, 0, 0);
const seventShenQing = new specialEvent("申请项目", "你的申请通过了，拿到小额项目经费。还能学到些新东西。", GRI(500,800), GRI(4,6), 0, 0, GRI(1,2), 0, 0, 0, 0, 0);
const seventGongYi = new specialEvent("公益讲座", "听完讲座心态更积极了。（心情、精力小幅恢复。）", 0, GRI(4,6), 0, GRI(4,6), 0, 0, 0, 0, 0, 0);
const seventXiaoXin = new specialEvent("校内实习", "跟着学长做项目，拿到一笔小补贴。（金钱增加，财商提升。）", GRI(800,1200), 0, 0, -GRI(4,6), 0, GRI(1,2), 0, 0, 0, 0);
const seventZaoShui = new specialEvent("规律作息", "作息稳定的一周，整个人状态好很多。（恢复体力与精力。）", 0, 0, GRI(6,10), GRI(6,10), 0, 0, 0, 0, 0, 0);
const seventShuiMian = new specialEvent("深度睡眠", "昨晚睡得特别香，一觉睡到自然醒。（精力大幅增加，心情小幅增加。）", 0, GRI(5,10), 0, GRI(15,25), 0, 0, 0, 0, 0, 0);
const seventDaCan = new specialEvent("美味大餐", "食堂今天做了特别好吃的菜，吃完感觉充满力量。（精力、心情、体力小幅增加。）", -GRI(20,40), GRI(5,10), GRI(5,10), GRI(8,12), 0, 0, 0, 0, 0, 0);
const seventGuLi = new specialEvent("收到鼓励", "收到了家人的鼓励短信，感觉干劲十足。（精力、心情增加。）", 0, GRI(10,15), 0, GRI(10,15), 0, 0, 0, 0, 0, 0);
const seventBaoPeng = new specialEvent("状态爆棚", "不知道为什么，今天感觉特别精神，好像有使不完的劲。（精力大幅增加。）", 0, 0, 0, GRI(20,30), 0, 0, 0, 0, 0, 0);
const goodSeventList = [seventJianQian, seventJiangzuo, seventShiJuan, seventJingSai, seventPoCai, seventZhiYuan, seventShenQing, seventGongYi, seventXiaoXin, seventZaoShui, seventShuiMian, seventDaCan, seventGuLi, seventBaoPeng];
//给更强buff的正面事件
...
const seventDaoShi = new specialEvent("导师赏识", "导师认可你的潜力，单独给你开了小灶。（智商上升，期末成绩大幅提升。）", 0, GRI(5,10), 0, 0, GRI(4,6), 0, 0, 0, 0, GRI(8,12));
const seventDaJiang = new specialEvent("校级大奖", "拿到校级大奖，奖金丰厚，整个人都飘了。（大幅增加金钱与财商。）", GRI(3000,5000), GRI(8,12), 0, 0, 0, GRI(2,4), 0, 0, 0, 0);
const seventXueShu = new specialEvent("学术突破", "论文被导师点赞，学术水平大进。（智力上升，期末成绩提升。）", 0, GRI(6,10), 0, 0, GRI(3,5), 0, 0, 0, 0, GRI(6,10));
const seventNeiTui = new specialEvent("名企内推", "师兄给了你一次内推机会，未来更有底气。（财商与战斗力提升。）", 0, GRI(6,10), 0, 0, 0, GRI(2,4), GRI(2,4), 0, 0, 0);
const vgoodSeventList = [seventManJi, seventZhanLi, seventXianRen, seventYinHang, seventXinPing, seventDaoShi, seventDaJiang, seventXueShu, seventNeiTui];
